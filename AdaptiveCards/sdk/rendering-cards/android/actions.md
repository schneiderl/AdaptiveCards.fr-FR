...
* ```onMediaPlay``` est appelée quand le bouton de lecture est enfoncé pour la première fois dans un élément multimédia
* ```onMediaStop``` est appelé lorsque le support atteint son extrémité
